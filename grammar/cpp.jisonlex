...
/* character */
character-literal               'L'?{QUOTE}{c-char}*{QUOTE}
c-char                          [^'{backslash}]|{escape-sequence}|{universal-character-name}
escape-sequence                 {simple-escape-sequence}|{octal-escape-sequence}|{hexadecimal-escape-sequence}
simple-escape-sequence          {backslash}['"?{backslash}abfnrtv]
...
"using"                         return 'USING';
"virtual"                       return 'VITUAL';
"void"                          return 'VOID';
"volatile"                      return 'VOLATILE';
"wchar_t"                       return 'WCHAR_T';
"while"                         return 'WHILE';
{alternative-operator}          return 'ALT_OPERATOR';
/* literals */
...
{fractional-constant}           return 'FractionalConstant';
